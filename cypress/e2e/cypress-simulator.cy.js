describe('Cypress Simulator', () => {
  ...
  onBeforeLoad(win) {
    ...
    it.only('Verifica os estados ativado e desativado do botão Executar.', () => {
    ...
    it('reseta a area de texto quando deslogo e logo novamente', () => {


    })

    it('desabilita o botão run depois de deslogar', () => {


    })

    it('reseta a saida do código após deslogar e logar', () => {


    })

    it('Sem banner de cookies quando é deslogado da página', () => {
